...
//        System.out.println("NLB  业务大小"+sum+"G"+"   seed:"+Constant.seed);
...
//        }
//
//        System.out.println("链路平均资源利用率："+aveSpeUtiRate/21);
...
//            sum1+=l.getRemCapacity();
//        }
//        aveLpSpeUti=sum1/gv.getLpLinklist().size();
//        System.out.println("平均光通道剩余资源比例："+aveLpSpeUti);
//
...
//        Dijkstra dijkstra=new Dijkstra();
//        /*调制格式*/
//        ModuFormat BPSK=new ModuFormat("BPSK",375);
//        ModuFormat QPSK=new ModuFormat("QPSK",750);
//        ModuFormat eightQAM=new ModuFormat("8-QAM",1125);
//        /*
...
//                continue;
//            }
//            reTotal_Cost=newGv.getNipB()*2.8+newGv.getNipQ()*3.6+newGv.getNipM()*4.2+newGv.getNregenB()*1.4+newGv.getNregenQ()*1.8+newGv.getNregenM()*2.1;
...
//                                        if (route.getHops()==hops&&route.getVlinklist().size()!=0){
//
...
//                                                    if ((service - lp.getRemCapacity()) >= 0) {
//                                                        service = service - lp.getRemCapacity();
//                                                        lp.setRemCapacity(0);
//                                                    } else {
...
//
//        Total_Cost=gv.getNipB()*2.8+gv.getNipQ()*3.6+gv.getNipM()*4.2+gv.getNregenB()*1.4+gv.getNregenQ()*1.8+gv.getNregenM()*2.1;
//
...
//            cost=newGv.getNipB()*2.8+newGv.getNipQ()*3.6+newGv.getNipM()*4.2+newGv.getNregenB()*1.4+newGv.getNregenQ()*1.8+newGv.getNregenM()*2.1;
