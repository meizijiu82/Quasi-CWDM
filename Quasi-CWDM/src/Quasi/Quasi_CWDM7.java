...
//            System.out.println("lightpath:"+lightpath.getName()+"  moduFormat:"+lightpath.getModuFormat().getName()+"  channels:"+lightpath.getChannels());
        ...
        System.out.println("AR  业务大小"+sum+"G"+"   seed:"+Constant.seed+"   业务数"+Constant.serviceSum);
...
//                                        if (route.getRemCapacity()==routeLength&&route.getVlinklist().size()!=0){
...
////                                                            }
//
//                                                            //业务不能拆分，选取能满足grooming且剩余容量最小的的光通道
//                                                            if (lp.getRemCapacity()>=service){
//                                                                lp.setRemCapacity(lp.getRemCapacity()-service);
//                                                                v.setRemCapacity(0);
//                                                                break L;
...
//                                        }
                        ...
                        buildAdaptiveLightpath(layer, gv, BPSK, QPSK, eightQAM, existNodeList, service, nodepair, srcNode, desNode, lightpath, vlink, dijkstra, judge);
                        break Loop;
                    }
                }
            }
    ...
    static void buildAdaptiveLightpath(Layer layer, Gv gv, ModuFormat BPSK, ModuFormat QPSK, ModuFormat eightQAM, HashSet<Node> existNodeList,
                                       int service, Nodepair nodepair, Node srcNode, Node desNode, Lightpath lightpath, Vlink vlink,
...
//                                   System.out.print("途经链路不满足节点对需求！  ");
                                    ...
                                    LinkedList<Integer>routeArr=new LinkedList<>();
                                    for (Route route:routeArrayList) {
                                        routeArr.add(route.getLength());   //得到所有路由的长度
                                    }
