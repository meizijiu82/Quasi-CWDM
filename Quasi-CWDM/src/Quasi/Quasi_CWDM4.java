...
//import general.*;
//
//public class Quasi_CWDM4 {
//
//    public void Quasi_CWDM() {
...
//        HashSet<Vlink>existVlinkList=new HashSet<>();
...
////                                            arr.add(route.getRemCapacity());    //根据最小跳数选择路由进行grooming
//                                            arr.add(route.getMaxWaveNum());           //根据最大波长数选择路由进行grooming
//                                        }
//                                    }
//                                    Collections.sort(arr);                  //将所有数据从小到大排序
//                                    int load = 0;
//                                    if (arr.size()!=0){
//                                        load=arr.getFirst();        //找到负载最小的一条路由进行grooming
//                                    }
//
//                                    boolean satisfyGrooming=true;
//                                    for (Route route:routeArrayList){
//                                        if (route.getMaxWaveNum()==load){
...
//        HashSet<Vlink>existVlinkList=new HashSet<>();
////        HashSet<Lightpath>exitVlinkList=new HashSet<>();
//
//        Dijkstra dijkstra=new Dijkstra();
//        Wavelength wavelength=new Wavelength();
...
//
//        int serial=0;
//        int judgeNum=serviceList.size()/6;
